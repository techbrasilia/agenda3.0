...
class CompromissosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compromisso" do
    assert_difference('Compromisso.count') do
      post compromissos_url, params: { compromisso: { data: @compromisso.data, empregado_id: @compromisso.empregado_id, hora: @compromisso.hora, tipo: @compromisso.tipo } }
    end
  ...
  test "should update compromisso" do
    patch compromisso_url(@compromisso), params: { compromisso: { data: @compromisso.data, empregado_id: @compromisso.empregado_id, hora: @compromisso.hora, tipo: @compromisso.tipo } }
